 ...
 * @return
 */
function AutoReader(tempJson,windowSize,dataBind,dataInfo,pageLength){
	 ...
	 * 根据浏览器大小确定页面的显示大小
	 */
 	AutoReader.prototype.setPageSize=function(windowSize){
	 ...
	 * 获取文章数据
	 */
	AutoReader.prototype.getDataBind=function(dataBind){
		return document.getElementById(dataBind);
	}
	/*
	 * 获得数据信息
	 */
	AutoReader.prototype.getDataInfo=function(dataInfo){
	 ...
	 * 获得文章分页后分页信息
	 */
	AutoReader.prototype.getPageInfo=function(tempJson){
	 ...
	 * 获得浏览器可用显示区域大小
	 */
	AutoReader.prototype.getBrowserClentSize=function(){
		var size = new Object();
	 ...
	 *            模板字符串
	 */
	AutoReader.prototype.parsingTemplate=function (tepInfoStr){
	 ...
	 *            模版信息
	 */
	AutoReader.prototype.displayBlock=function (block,tempBlock){
		/*
		 * 获得dom元素
		 */
	 ...
	 *            文章信息
	 */
	AutoReader.prototype.metchTempByWeight=function (dataInfo,tempJson){
		/**
		 * 初始化变量
		 */
		var pages=new Array();
	 ...
	 *            $blockAmount
	 */
	AutoReader.prototype.getTemplates=function(blockAmount,tempJson){
	...
	AutoReader.prototype.getTempUsedWeight=function(tempId){
	...
	AutoReader.prototype.setTempUsedWeight=function(tempId){
		for(i=0;i<tempateJson.length;i++){
			if(tempateJson[i].ti==tempId){
	 ...
	 * @param $blockAmount
	 */
	AutoReader.prototype.getTemplate=function (ti,tempJson){
		for(i=0;i<tempJson.length;i++){
			if(tempJson[i].ti==ti){
				var temp=new Array();
				temp["ti"]=tempJson[i].ti;
	 ...
	 */
	AutoReader.prototype.diplayPages=function (pages,tempJson,dataBind){
		/*
		 * 初始化数据
		 */
		var page=new Array();
	 ...
	 *            文章
	 */
	AutoReader.prototype.getImgBlockSizeCollate=function  (block,img){
	 ...
	 *            文章
	 */
	AutoReader.prototype.setImgDidplay=function (block,img,ibsc){
	 ...
	 * @param submultiple
	 */
	AutoReader.prototype.getMarginBottom=function (imgHeight,submultiple){
	 ...
	 * @param datas 数据
	 */
    AutoReader.prototype.sortDataByWeight=function (datas){
		var key;
		var t;
	 ...
	 *            模板内的区块
	 */
	AutoReader.prototype.sortBlockByWeight=function (blocks){
		var key;
		var t;
	 ...
	 * 输入数据并显示模版源
	 */
	AutoReader.prototype.saw=function(){
